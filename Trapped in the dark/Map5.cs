...
public class Map5 : GameScreen
{
    ...
    public Map5(Game1 game) : base(game)
    {
        _myGame = game;
    }
    public override void LoadContent()
    {
        ...
        //tileMap
        _tiledMap = Content.Load<TiledMap>("Map5");
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        ushort bluex = (ushort)(_positionPersoBlue.X  );
        ushort bluey = (ushort)(_positionPersoBlue.Y );
        ushort redx = (ushort)(_positionPersoRed.X );
        ushort redy = (ushort)(_positionPersoRed.Y );
